  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div class="product-page-wrap">
      ...
      <div class="<?php if ( get_field('first_image') || get_field('second_image') || get_field('third_image') ) { echo 'product-modal-right'; } ?> sub-block">
        ...
        <?php endif; ?>
        <a href="#" class="btn contact-btn" data-subject="Купить продукт (<?php the_title(); ?>)">Купить</a>
        <div class="size-chart-cont">
          <h3 class="size-chart-title">Размерная сетка</h3>
          <div class="size-chart-imgs-cont">
            <?php if ( get_field('size_chart') ) { ?>
              <div class="size-chart-img-cont">
                <img src="<?php the_field('size_chart'); ?>" alt="Размерная сетка" class="size-chart-img">
              </div>
            <?php } else { if ($post->ID == 51) { ?>
              <div class="size-chart-img-cont">
                <img src="/wp-content/uploads/2018/03/light-sweatshirt-size-chart.png" alt="Размерная сетка" class="size-chart-img">
              </div>
            <?php } } ?>
            <div class="plan-img-cont">
              <img src="<?php echo get_template_directory_uri() . '/assets/src/img/png/plan.png'; ?>" alt="Размерная сетка" class="plan-img">
            </div>
          </div>
        </div>
    ...
    <?php get_template_part('blocks/ru/contact-form'); ?>
