<div id="products-block" class="site-block">
  ...
  <h3 class="title">ПРОДУКЦІЯ T-STORE</h3>

  <hr class="divider">

  <p class="desc">Продукція T-Store пошита на українських виробництвах з щільної турецької тканини преміум якості за стандартними європейськими лекалами. Ви отримуєте якісний одяг, який відповідає заявленим розмірами, не сідає, не розтягується і не рветься.</p>
