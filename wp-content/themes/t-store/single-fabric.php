...
<main class="main-content">
  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <div class="carousel-inner" role="listbox">
              <?php if ( get_field('first_image') ) : ?>
                <div class="item active">
                  <img src="<?php the_field('first_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('second_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('second_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('third_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('third_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('fourth_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('fourth_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('fifth_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('fifth_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('sixth_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('sixth_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('seventh_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('seventh_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
              <?php if ( get_field('eighth_image') ) : ?>
                <div class="item">
                  <img src="<?php the_field('eighth_image'); ?>" alt="Фото продукту" class="carousel-slide-img">
                </div>
              <?php endif; ?>
            </div>
      ...
      <div class="<?php if ( get_field('first_image') || get_field('second_image') || get_field('third_image') ) { echo 'product-modal-right'; } ?> sub-block">
        ...
        <?php if ( get_field('color_1') || get_field('color_2') || get_field('color_3') || get_field('color_4') || get_field('color_5') || get_field('color_6') || get_field('color_7') || get_field('color_8') ) : ?>
          <div class="colours-wrap">
            <p class="colours-title">Кольори: </p>
          ...
          <div class="prices-wrap">
            <?php if ( get_field('price_5_20') ) : ?>
              <div class="price-wrap">
                <p class="price-count">5-20 шт.</p>
                <p class="price-number"><?php the_field('price_5_20') ?></p>
              </div>
            <?php endif; ?>
            <?php if ( get_field('price_21_50') ) : ?>
              <div class="price-wrap">
                <p class="price-count">21-50 шт.</p>
                <p class="price-number"><?php the_field('price_21_50') ?></p>
              </div>
            <?php endif; ?>
            <?php if ( get_field('price_51_100') ) : ?>
              <div class="price-wrap">
                <p class="price-count">51-100 шт.</p>
                <p class="price-number"><?php the_field('price_51_100') ?></p>
              </div>
            <?php endif; ?>
          </div>
        <?php endif; ?>
        <a href="#" class="btn contact-btn" data-subject="Купити продукт (<?php the_title(); ?>)">Купити</a>
        <div class="size-chart-cont">
          <h3 class="size-chart-title">Розмірна сітка</h3>
          <div class="size-chart-imgs-cont">
            <?php if ( get_field('size_chart') ) { ?>
              <div class="size-chart-img-cont">
                <img src="<?php the_field('size_chart'); ?>" alt="Розмірна сітка" class="size-chart-img">
              </div>
            <?php } else { if ($post->ID == 216) { ?>
              <div class="size-chart-img-cont">
                <img src="/wp-content/uploads/2018/03/light-sweatshirt-size-chart.png" alt="Розмірна сітка" class="size-chart-img">
              </div>
            <?php } } ?>
            <div class="plan-img-cont">
              <img src="<?php echo get_template_directory_uri() . '/assets/src/img/png/plan.png'; ?>" alt="Розмірна сітка" class="plan-img">
            </div>
          </div>
        </div>
    ...
    <?php get_template_part('blocks/ua/contact-form'); ?>
